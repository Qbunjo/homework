...
String szerSt =
      JOptionPane.showInputDialog ("Podaj wymiar długości pomieszczenia:");
    
double szer = Double.parseDouble (szerSt);
    
String dlugSt =
      JOptionPane.showInputDialog ("Podaj wymiar szerokości pomieszczenia:");
    
double dlug = Double.parseDouble (dlugSt);
    
String wysSt =
      JOptionPane.
      showInputDialog ("Podaj wysokość pomieszczenia. (standard:2.50)",
		       "2.50");
...
JOptionPane.showMessageDialog (null,
				    " Całkowity koszt remontu to: " + total +
				    " PLN");
