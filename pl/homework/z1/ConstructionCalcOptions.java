...
public class ConstructionCalcOptions {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"Witaj w firmie remontowej. Kalkulator pomoże wyliczyć koszt remontu pomieszczenia.");
		...
		int gipsInput = JOptionPane.showConfirmDialog(null, "Czy chcesz gipsować ściany? :", "Wybierz opcję:",
		...
		int malInput = JOptionPane.showConfirmDialog(null, "Czy chcesz malować ściany? :", "Wybierz opcję:",
				JOptionPane.YES_NO_CANCEL_OPTION);
		...
		int paneleInput = JOptionPane.showConfirmDialog(null, "Czy chcesz połozyć panele? :", "Wybierz opcję:",
				JOptionPane.YES_NO_CANCEL_OPTION);
		...
		int listwyInput = JOptionPane.showConfirmDialog(null, "Czy chcesz położyć listwy? :", "Wybierz opcję:",
				JOptionPane.YES_NO_CANCEL_OPTION);
